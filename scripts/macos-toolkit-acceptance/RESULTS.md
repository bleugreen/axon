...
| --- | --- | --- | --- | --- | --- |
| `bbl-2026-08-16` | 2026-08-16T19:22:52-04:00 | arm64 macOS bench | Version 26.4 (Build 25E246) | granted | [`raw/bbl-2026-08-16.json`](raw/bbl-2026-08-16.json) |
...
| `AxonAcceptanceWebView-keyboard-2026-08-16` | AxonAcceptanceWebView (wkwebview) | `no bundle identifier` (not readable at dispatch) | `keyboard` | **blocked** | not observed | not observed | not observed | not established | before: not run; after: not run |
...
- Arrival: the application dequeued keyDown on window 3074, keyUp on window 3074, keyDown on window 3074, keyUp on window 3074, keyDown on window 3074, keyUp on window 3074, keyDown on window 3074, keyUp on window 3074
...
the trial could not be established: 'center'
